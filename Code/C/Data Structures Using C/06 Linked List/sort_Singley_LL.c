...
void sort()
{
    // if (CheckUnderflow(start))
    //     return;
    struct node *temp = start, *post_temp;
    ...
    while (temp != NULL)
    {
        ...
        {
            if (temp->data > post_temp->data)
            {
                int temp_data = temp->data;
                temp->data = post_temp->data;
                post_temp->data = temp_data;
                printf("\nExchanged %d with %d", temp->data, post_temp->data);
            }
