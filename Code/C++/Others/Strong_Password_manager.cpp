// Do not Copy!
//  Advanced Random Password Generator Programmed by me:
#include <iostream>
#include <cstdlib>
#include <ctime>
#include <fstream>
...
int main()
{
    ...
    cout << "Generated password has been saved in " << reason << " on your desktop.\n";
    cout << "Note: You are to open it with any text viewer you have available.\n\n";
    RandomPasser.close();
    cout << "Do you want to regenerate another Password?[Y/N]: ";
    string yesNo;
    cin >> yesNo;
    if (yesNo == "Y")
    {
